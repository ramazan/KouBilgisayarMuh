						...
						<div id="inner-footer" class="row clearfix">
		    				...
		    				<div class="col-md-4">
								...
								<p style="padding-left: 20px">KOÜ Mühendislik Fakültesi (B Blok)<br/>
								   ...
								   <br/>
								   <a href="tel:+90 (262) 303 35 60">+90 (262) 303 35 60</a><br/>
								   <a href="mailto:bilgisayar@kocaeli.edu.tr">bilgisayar@kocaeli.edu.tr</a>
								</p>
		    				...
		    				<div class="col-md-4">
								...
								<i class="fa fa-globe"></i><a href="http://kocaeli.edu.tr" target="_blank" style="text-decoration: none;	font-size: 14px;
								line-height: 30px;"> Kocaeli Üniversitesi</a><br/>
								<i  class="fa fa-users"></i><a  href="http://bilsis.kocaeli.edu.tr/" target="_blank" style="text-decoration: none;	font-size: 14px;
								line-height: 30px;"> Öğrenci Bilgi Sistemi</a><br/>
							    <i class="fa fa-child"></i><a  href="http://sksdb.kocaeli.edu.tr/?p=yemek_listesi/" target="_blank" style="text-decoration: none;	font-size: 14px;
								line-height: 30px;"> Kou Günlük Yemek Listesi</a><br/>
								<i class="fa fa-bar-chart"></i><a href="http://ogr.kocaeli.edu.tr/KOUBS/Istatistik/index.cfm" target="_blank" style="text-decoration: none;	font-size: 14px;
								line-height: 30px;"> Istatistik</a><br/>
								<i class="fa fa-map-marker"></i><a  href="http://mf.kocaeli.edu.tr" target="_blank" style="text-decoration: none;	font-size: 14px;
								line-height: 30px;"> Mühendislik Fakültesi</a><br/>
								<i class="fa fa-book"></i><a href="http://kutuphane.kocaeli.edu.tr/anasayfa.php" target="_blank" style="text-decoration: none;	font-size: 14px;
