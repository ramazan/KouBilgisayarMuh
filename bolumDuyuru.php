...
<?php
					    ...
					    die("HATA: Veritabanı bağlantısı kurulamadı. " . mysqli_connect_error());
								 	...
								 	#Sorgu yapılıyor..
							$sql = "SELECT users.NAME,announcements.TITLE,announcements.MESSAGE,announcements.DUYURU_TURU,announcements.DATE , announcements.ID	FROM announcements INNER JOIN users ON users.ID=announcements.USER_ID WHERE DUYURU_TURU='Bolum' AND  STATUS='1' ORDER BY ID DESC;";
