...
<div class="wrapper">
        ...
        <div class="container">
		  ...
		  <div style="text-align:center;border-bottom: 2px solid #333; padding-bottom:8px;"></div>
            ...
            <?php
                ...
                $sql = "SELECT * FROM users WHERE ROLE ='user' and ANA_BILIM_DALI='Bilgisayar Yazılım';";
  ...
  <div class="col-md-12">
               <div style="text-align:center;border-bottom: 2px solid #333; padding-bottom:8px;"></div>
            <h3 style="text-align:center;border-bottom: 2px solid #333; padding-bottom:8px;">Bilgisayar  Donanım </h3>
			  <br><br>
            </div>     
					   <?php
				include_once './dbbaglantisi.php';  
                $sql = "SELECT * FROM users WHERE ROLE ='user' and ANA_BILIM_DALI='Bilgisayar Donanım';";
  ...
  ?>
				...
				<div class="col-md-12">
              <div style="text-align:center;border-bottom: 2px solid #333; padding-bottom:8px;"></div>
            <h3 style="text-align:center;border-bottom: 2px solid #333; padding-bottom:8px;">Bilgisayar  Bilimleri </h3>
			  <br><br>
            </div>     
					   <?php
				include_once './dbbaglantisi.php';  
                $sql = "SELECT * FROM users WHERE ROLE ='user' and ANA_BILIM_DALI='Bilgisayar Bilimleri';";
